          ...
          <ul>
            {
              type === 'default'
                ? (
                  snippets.map((snippet) => (
                    <li key={snippet.id}>
                      ...
                      >
                        <p className="font-body2-regular font-geist text-dev-white-200 dark:text-dev-black-1000">
                          Example: {snippet.id}
                        </p>
                        <p className="font-body3-regular font-geist text-dev-white-1000 dark:text-dev-black-300">
                          CUSTOM
                        </p>
                      </button>
                    </li>
                ...
                : (
                  <li className="font-body1-regular font-geist text-dev-white-1000 dark:text-dev-black-300">
                    No examples found
                  </li>
                )
            }

    ...
    <div className="grid gap-4">
      ...
      {filter === 'extrinsics' && (
        <table className="w-full">
          ...
          {
            blockDetails.extrinsics.slice(0, showMore ? blockDetails.extrinsics.length : 3).map((extrinsic, extrinsicIndex) => {
      ...
      {filter === 'events' && (
        <table className="w-full">
          ...
          {
            blockDetails.events.slice(0, showMore ? blockDetails.events.length : 3).map((event, eventIndex) => {
      ...
      {(blockDetails.extrinsics.length > 3 || blockDetails.events.length > 3) && (
